...
## Prinsip-prinsip OOP
1. **Abstraction** : Class MakananLebaran digunakan sebagai gambaran umum dari makanan Lebaran dan tidak dapat dibuat objek secara langsung, melainkan menjadi dasar bagi subclass seperti MakananUtama dan KueKering.
2. **Inheritance** : Class Makanan Utama dan KueKering merupakan subclass (derived class atau turunan) dari MakananLebaran (base class). Digunakan untuk mengelompokkan kategori makanan lebaran.
3. **Encasuplation** : Data pada class Resep seperti bahan dan langkah disimpan dalam atribut private sehingga hanya bisa diakses dalam class tersebut saja.
4. **Polymorphism** : Method tampilkanInfo() di-override pada subclass untuk memberikan output yang berbeda sesuai kategori makanan
